...
public enum SomeStringsForCheatSwitch {
	Bazaar, Cover, DeLorean, Diamond, Energize, Events, Fame, Go, Ice, Pirate, Police, Trader, Indemnity, IOU, Iron, Juice, Knack, LifeBoat, L_Engle, MonsterCom, PlanB, Posse, RapSheet, Rarity, Scratch, Skin, Status, Artifact, Dragonfly, Experiment, Gemulon, Japori, Jarek, Moon, Reactor, Princess, Scarab, Sculpture, SpaceMonster, Wild, Swag, Test, Tool, Varmints, Yellow, Cheetah, I, N, P, F, T, E, S, Q, M,
