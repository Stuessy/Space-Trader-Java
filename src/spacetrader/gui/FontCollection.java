...
final class FontCollection {
	...
	static final Font regular825 = new Font(FONT_FAMILY, 8.25F,
			FontStyle.Regular, GraphicsUnit.Point, 0);

	// was supposed to be 8.25f size, but it's too wide for the space allocated.
	// Made it a bit smaller...
	static final Font bold825 = new Font(FONT_FAMILY_BOLD, 7F, FontStyle.Bold,
			GraphicsUnit.Point, 0);
	static final Font bold10 = new Font(FONT_FAMILY_BOLD, 10F, FontStyle.Bold,
			GraphicsUnit.Point, 0);
	static final Font bold12 = new Font(FONT_FAMILY_BOLD, 12F, FontStyle.Bold,
			GraphicsUnit.Point, 0);
