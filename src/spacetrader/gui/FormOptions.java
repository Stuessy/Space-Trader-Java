...
public class FormOptions extends SpaceTraderForm {
	...
	private void InitializeComponent() {
		...
		this.chkContinuousAttack
				.setCheckedChanged(new EventHandler<Object, EventArgs>() {
					@Override
					public void handle(Object sender, jwinforms.EventArgs e) {
						controlChanged(sender, e);
					}
	...
	private void UpdateAll() {
		...
		chkIgnoreTradersDealing.setChecked(Options()
	...
	private void controlChanged(Object sender, EventArgs e) {
		if (!initializing) {
			...
			Options().setAlwaysIgnoreTradeInOrbit(
					chkIgnoreTradersDealing.isChecked());
