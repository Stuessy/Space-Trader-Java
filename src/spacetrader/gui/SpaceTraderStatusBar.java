...
class SpaceTraderStatusBar extends StatusBar {
	...
	public void InitializeComponent() {
		...
		Panels.addAll(Arrays.asList(new jwinforms.StatusBarPanel[] {
	...
	public void BeginInit() {
		...
		statusBarPanelExtra = new jwinforms.StatusBarPanel(
				jwinforms.StatusBarPanelAutoSize.Spring);
	...
	public void Update() {
		if (commander == null) {
			...
			statusBarPanelCash.setText("Cash: "
					+ Functions.FormatMoney(commander.getCash()));
			statusBarPanelBays.setText("Bays: "
					+ commander.getShip().FilledCargoBays() + "/"
					+ commander.getShip().CargoBays());
			statusBarPanelCosts.setText("Current Costs: "
					+ Functions.FormatMoney(commander.CurrentCosts()));
			statusBarPanelExtra.setText("");
		}
	}

	private void statusBar_PanelClick(Object sender,
			jwinforms.StatusBarPanelClickEventArgs e) {
		if (commander != null) {
