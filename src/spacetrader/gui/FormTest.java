...
public class FormTest extends SpaceTraderForm {
	...
	public FormTest() {
		...
		AlertType[] alerts = Arrays.copyOfRange(AlertType.values(),
				AlertType.Alert.ordinal(),
				AlertType.WildWontStayAboardReactor.ordinal());
		// for (AlertType type = AlertType.Alert; type.CastToInt() <=
		// AlertType.WildWontStayAboardReactor.CastToInt(); type++)
		for (AlertType type : alerts)
			selAlertType.Items.add(type);
		selAlertType.setSelectedIndex(0);

		SpecialEventType[] events = Arrays.copyOfRange(
				SpecialEventType.values(), SpecialEventType.Artifact.ordinal(),
				SpecialEventType.WildGetsOut.ordinal());
		// for (SpecialEventType type = SpecialEventType.Artifact; type <
		// SpecialEventType.WildGetsOut; type++)
	...
	private void InitializeComponent() {
		...
		this.lblAlertType.setSize(new Dimension(56, 13));
		...
		this.boxAlert.Controls.addAll((new WinformControl[] {
				this.btnTestAlert, this.txtValue3, this.txtValue2,
				this.txtValue1, this.selAlertType, this.lblValue3,
				this.lblValue1, this.lblValue2, this.lblAlertType }));
		this.boxAlert.setLocation(new java.awt.Point(8, 8));
		this.boxAlert.setName("boxAlert");
		this.boxAlert.setSize(new Dimension(200, 152));
		...
		this.btnTestAlert.setSize(new Dimension(41, 22));
		...
		this.txtValue3.setSize(new Dimension(120, 20));
		...
		this.txtValue2.setSize(new Dimension(120, 20));
		...
		this.txtValue1.setSize(new Dimension(120, 20));
		...
		this.selAlertType.setSize(new Dimension(120, 21));
		...
		this.lblValue3.setSize(new Dimension(43, 13));
		...
		this.lblValue1.setSize(new Dimension(43, 13));
		...
		this.lblValue2.setSize(new Dimension(43, 13));
		...
		this.btnTestSpecialEvent.setSize(new Dimension(41, 22));
		...
		this.selSpecialEvent.setSize(new Dimension(104, 21));
		...
		this.lblSpecialEvent.setSize(new Dimension(73, 13));
		...
		this.setClientSize(new Dimension(370, 255));
		this.Controls.addAll(Arrays.asList(this.groupBox1, this.boxAlert));
	...
	private void btnTestAlert_Click(Object sender, EventArgs e) {
		GuiFacade.alert(
				AlertType.Alert,
				"Result",
				("The result was " + GuiFacade.alert(
						((AlertType) selAlertType.getSelectedItem()),
						txtValue1.getText(), txtValue2.getText(),
						txtValue3.getText()).toString()));
	}

	private void btnTestSpecialEvent_Click(Object sender, EventArgs e) {
		SpecialEvent specEvent = Consts.SpecialEvents[((SpecialEventType) selSpecialEvent
				.getSelectedItem()).CastToInt()];
		String btn1, btn2;
		...
		(new FormAlert(specEvent.Title(), specEvent.String(), btn1, res1, btn2,
				res2, null)).ShowDialog(this);
	}
